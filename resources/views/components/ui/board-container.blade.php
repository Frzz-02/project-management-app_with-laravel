...
<!-- Project Boards Section -->
    <div class="bg-white/60 backdrop-blur-xl rounded-2xl shadow-xl border border-white/40 p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            @if(!$isCardStatus)
                <button class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
